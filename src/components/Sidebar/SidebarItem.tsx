    ...
    <>
      <li>
        <Link
          ...
          onClick={handleClick}
          className={`${
            isItemActive ? "bg-[#fcaa38] text-white" : "bg-white text-[#222222]"
          } group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium duration-300 ease-in-out hover:bg-[#FFBF68] hover:text-[#222222]`}
        >
          {item.icon}
          {item.label}
          {item.children && (
