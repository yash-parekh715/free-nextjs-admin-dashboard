      ...
      },
      {
        icon: (
          ...
          >
            ...
            <circle cx="13" cy="9" r="2" stroke="#222222" strokeWidth="1.2" />
            <path d="M13 9L14 10" stroke="#222222" strokeWidth="1.2" />
            <path d="M13 9L12 10" stroke="#222222" strokeWidth="1.2" />
          </svg>
        ),
        label: "Menu Items",
        route: "/menu_items",
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`fixed left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-white text-[#222222] duration-300 ease-linear dark:bg-boxdark lg:translate-x-0 ${
        ...
        <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
          ...
          <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
            {menuGroups.map((group, groupIndex) => (
              <div key={groupIndex}>
                <h3 className="mb-4 ml-4 text-sm font-semibold text-[#222222]">
                  {group.name}
                </h3>
